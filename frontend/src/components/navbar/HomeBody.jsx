      ...
      <main class="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 mt-8 md:mt-24">
        <div class="max-w-lg max-md:mt-7">
          <h1 class="font-bold text-4xl md:text-5xl text-black">
            ...
            <span class="text-blue-500"> — Easy Loans, Trusted Support.</span>
          </h1>
          <p class="mt-8 text-gray-500 text-sm sm:text-base">
            Empowering you to reach new heights—together, we can achieve more!
          </p>
        ...
        <img
          class="w-52 md:w-80 scale-x-[-1] max-md:mt-10"
          src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/thinkingImage.svg"
          alt="thinkingImage"
        />
      </main>
      <div class="mt-10 md:mt-12 max-w-4xl mx-auto flex items-center justify-center text-gray-600 text-xs md:text-sm pb-12">
        <div class="flex flex-col md:flex-row text-center items-center md:gap-2 px-4 max-md:py-3 md:px-6 border-r border-gray-300">
          <svg
            class="w-6 md:w-8"
            width="36"
            height="36"
        ...
        <div class="flex flex-col md:flex-row text-center items-center md:gap-2 px-4 max-md:py-3 md:px-6">
          <svg
            class="w-6 md:w-8"
            width="37"
            height="37"
